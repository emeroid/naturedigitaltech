...
@section('title', 'Create Category || Nature Digital Tech - Making life easy')

@section('content')

  @section('crumb-folder', 'Category')
  @section('crumb-name', 'Create')
          ...
          <form action="{{route('admin.category.save')}}" method="post" enctype="multipart/form-data">
            ...
            <div class="row">
              <div class="col-md-7 form-group g-mb-20">
                ...
                <input class="form-control g-color-black g-bg-white g-bg-white--focus g-brd-gray-light-v4 g-brd-primary--focus rounded-3 g-py-13 g-px-15" type="text" placeholder="Category name" name="title" >
              </div>

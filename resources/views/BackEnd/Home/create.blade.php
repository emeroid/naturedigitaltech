...
@section('title', 'Create Home Content || Nature Digital Tech - Making life easy')

@section('content')

  @section('crumb-folder', 'Home Content')
  @section('crumb-name', 'Home Create')
    ...
    <section class="container g-pt-50 g-pb-50">
      <div class="row u-shadow-v1-5 g-line-height-2 g-pt-50 g-pb-10 ustify-content-center g-py-15 g-px-15">
       ...
       <div class="col-lg-12 g-mb-60">
          <form action="{{route('admin.setting.home.save')}}" method="post" enctype="multipart/form-data">
            ...
            <div class="row">
              <div class="col-md-7 form-group g-mb-20">
                ...
                <input class="form-control g-color-black g-bg-white g-bg-white--focus g-brd-gray-light-v4 g-brd-primary--focus rounded-3 g-py-13 g-px-15" type="text" placeholder="Name" name="title" value="{{old('title')}}" >
              </div>
            ...
            <div class="row">
              <div class="col-md-7 form-group g-mb-20">
                ...
                <textarea class="form-control g-color-black g-bg-white g-bg-white--focus g-brd-gray-light-v4 g-brd-primary--focus rounded-3 g-py-13 g-px-15" type="text" placeholder="Category Description" name="body" id="body"> {{old('body')}} </textarea>
              </div>
            ...
            <div class="row">
              <div class="col-md-7 form-group g-mb-20">
                ...
                <input class="form-control g-color-black g-bg-white g-bg-white--focus g-brd-gray-light-v4 g-brd-primary--focus rounded-3 g-py-13 g-px-15" type="text" placeholder="Type your color here" name="bg_color" value="{{old('bg_color')}}">
              </div>
            ...
            <div class="row">
              <div class="col-md-7 form-group g-mb-20">
                ...
                <input class="form-control g-color-black g-bg-white g-bg-white--focus g-brd-gray-light-v4 g-brd-primary--focus rounded-3 g-py-13 g-px-15" type="text" placeholder="Select color" name="btn_link" value="{{old('btn_link')}}" >
              </div>

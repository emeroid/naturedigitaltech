    ...
    <section class="container g-pt-50 g-pb-50">
      <div class="row u-shadow-v1-5 g-line-height-2 g-pt-50 g-pb-10 ustify-content-center g-py-15 g-px-15">
       ...
       <div class="col-lg-7 g-mb-60">
          <form action="{{route('admin.training.schedule.live.save')}}" method="post" enctype="multipart/form-data">
            ...
            <div class="row">
             ...
             <div class="row">
              <div class="col-md-12 form-group g-mb-20">
                ...
                <input class="form-control g-color-black g-bg-white g-bg-white--focus g-brd-gray-light-v4 g-brd-primary--focus rounded-3 g-py-13 g-px-15" type="text" placeholder="WhatsApp Link" name="wha" >
              </div>

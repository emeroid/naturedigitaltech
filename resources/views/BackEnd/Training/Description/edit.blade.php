    ...
    <section class="container g-pt-50 g-pb-50">
      <div class="row u-shadow-v1-5 g-line-height-2 g-pt-50 g-pb-10 ustify-content-center g-py-15 g-px-15">
       ...
       <div class="col-lg-5 g-mb-60">
          <form action="{{route('admin.training.description.update')}}" method="post" enctype="multipart/form-data">
            ...
            <div class="row">
              <div class="col-md-12 form-group g-mb-20">
                ...
                <input class="form-control g-color-black g-bg-white g-bg-white--focus g-brd-gray-light-v4 g-brd-primary--focus rounded-3 g-py-13 g-px-15" type="text" placeholder="About us" name="title" value="{{$train_desc->title}}">
              </div>
            ...
            <div class="col-md-3">
              <img class="d-flex g-width-100 g-height-100 rounded-circle g-mr-10" src="/assets/img/Uploads/Training/description/{{$train_desc->img}}" >
            </div>
            ...
            <input type="hidden" name="_id" value="{{$train_desc->id}}">
        ...
        <div class="col-md-7">
          <div class="g-mb-40">
            ...
            <textarea class="form-control g-color-black g-bg-white g-bg-white--focus g-brd-gray-light-v4 g-brd-primary--focus g-resize-none rounded-3 g-py-13 g-px-15" rows="12" id="body" name="body" placeholder="Hi there, I would like to ...">{{$train_desc->body}} </textarea>
          </div>

...
@section('title', 'Create FAQ || Nature Digital Tech - Making life easy')
    ...
    <section class="container g-pt-50 g-pb-50">
      <div class="row u-shadow-v1-5 g-line-height-2 g-pt-50 g-pb-10 ustify-content-center g-py-15 g-px-15">
       ...
       <div class="col-lg-9 g-mb-60">
          <form action="{{route('admin.page.faq.save')}}" method="post" enctype="multipart/form-data">
            ...
            <div class="row">
              <div class="col-md-7 form-group g-mb-20">
                ...
                <input class="form-control g-color-black g-bg-white g-bg-white--focus g-brd-gray-light-v4 g-brd-primary--focus rounded-3 g-py-13 g-px-15" type="text" placeholder="Ask Question" name="q" >
              </div>
          ...
          <div class="g-mb-40">
            ...
            <textarea class="form-control g-color-black g-bg-white g-bg-white--focus g-brd-gray-light-v4 g-brd-primary--focus g-resize-none rounded-3 g-py-13 g-px-15" rows="12" id="a" name="a" placeholder="Hi there, I would like to ..."> </textarea>
          </div>

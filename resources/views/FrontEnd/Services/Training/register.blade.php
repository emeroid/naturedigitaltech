...
@section('title', 'Register for our course Program || Nature Digital Tech - Making life easy')

@section('content')

<!-- Request partnership -->
    <section class="u-bg-overlay g-bg-pos-top-center g-bg-img-hero g-bg-black-opacity-0_3--after g-py-100" style="background-image: url(../../assets/img/home/6.jpg);">
      <div class="container u-bg-overlay__inner">
        <div class="row justify-content-center text-center mb-5">
          <div class="col-lg-8">
            <!-- Heading -->
            <h1 class="g-color-white text-uppercase mb-4">Take our course</h1>
        ...
        <div class="row justify-content-center align-items-center no-gutters">
          ...
          <div class="col-lg-6 g-bg-white g-rounded-right-5--lg-up">
            <div class="g-pa-50">
              <!-- Form -->
              <form class="g-py-15" method="POST" action="{{ route('training.register.save') }}">
                        @csrf
                <h2 class="h3 g-color-black mb-4">Register for a course</h2>
                <p class="mb-4"></p>

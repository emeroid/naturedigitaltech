            ...
            <div class="g-pl-15--lg">
              ...
              <div class="d-flex justify-content-end align-items-center g-brd-bottom g-brd-gray-light-v4 g-pt-20 g-pb-10">
                <!-- Sort By -->
                  ...
                  <form action="{{route('product.category', product->slug)}}" method="get" enctype="multipart/form-data">
                            {{ csrf_field() }}

                    <div class="mb-4">
                      <select class="form-control form-control-sm rounded-0" name="category" onchange="this.form.submit();">
                        <option value=""></option>
          ...
          <div class="row">
              ...
              <div class="col-md-6 col-lg-3 g-mb-30">
                ...
                <article class="info-v5-6 g-pos-rel g-bg-gray-dark-v2 g-bg-primary--hover g-color-white g-rounded-4 g-transition-0_3">
                  ...
                  <!-- Article Image -->
                  <a href="{{route('product.item', $product->slug)}}"><img class="w-100 g-height-280" src="../../assets/img/products/{{$product->productImage->img}}" alt="{{$product->name}}"> </a>
                  <!-- End Article Image -->

                  <div class="u-ribbon-v1 g-width-55 g-bg-primary g-font-weight-600 g-font-size-17 g-top-0 g-left-0 p-0">
                    <span class="d-block g-bg-white g-color-primary g-line-height-0_8 g-py-15 text-center">30%
